...
func TestDatastore_Allocate(t *testing.T) {
	...
	if err != nil || v != 21 {
		t.Errorf("Allocate() == (%v, %q), want (%v, %q)", v, err, 21, nil)
	}
}
...
func TestDatastore_Chmod(t *testing.T) {
	...
	if err != nil || v != 42 {
		t.Errorf("Chmod() == (%v, %q), want (%v, %q)", v, err, 42, nil)
	}
}
...
func TestDatastore_Chown(t *testing.T) {
	...
	if err != nil || v != 42 {
		t.Errorf("Chown() == (%v, %q), want (%v, %q)", v, err, 42, nil)
	}
}
...
func TestDatastore_Enable(t *testing.T) {
	...
	if err != nil || v != 42 {
		t.Errorf("Enable() == (%v, %q), want (%v, %q)", v, err, 42, nil)
	}
}
