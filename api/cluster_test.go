...
func TestCluster_AddDataStore(t *testing.T) {
	...
	if err != nil || v != 42 {
		t.Errorf("AddDataStore() == (%v, %q), want (%v, %q)", v, err, 42, nil)
	}
}
...
func TestCluster_AddHost(t *testing.T) {
	...
	if err != nil || v != 42 {
		t.Errorf("AddHost() == (%v, %q), want (%v, %q)", v, err, 42, nil)
	}
}
...
func TestCluster_AddVNet(t *testing.T) {
	...
	if err != nil || v != 42 {
		t.Errorf("AddVNet() == (%v, %q), want (%v, %q)", v, err, 42, nil)
	}
}
...
func TestCluster_Allocate(t *testing.T) {
	...
	if err != nil || v != 42 {
		t.Errorf("Allocate() == (%v, %q), want (%v, %q)", v, err, 42, nil)
	}
}
...
func TestCluster_DelDataStore(t *testing.T) {
	...
	if err != nil || v != 42 {
		t.Errorf("DelDataStore() == (%v, %q), want (%v, %q)", v, err, 42, nil)
	}
}
...
func TestCluster_Delete(t *testing.T) {
	...
	if err != nil || v != 42 {
		t.Errorf("Delete() == (%v, %q), want (%v, %q)", v, err, 42, nil)
	}
}
...
func TestCluster_DelHost(t *testing.T) {
	...
	if err != nil || v != 42 {
		t.Errorf("DelHost() == (%v, %q), want (%v, %q)", v, err, 42, nil)
	}
}
...
func TestCluster_DelVNet(t *testing.T) {
	...
	if err != nil || v != 42 {
		t.Errorf("DelVNet() == (%v, %q), want (%v, %q)", v, err, 42, nil)
	}
}
...
func TestCluster_Rename(t *testing.T) {
	...
	if err != nil || v != 42 {
		t.Errorf("Rename() == (%v, %q), want (%v, %q)", v, err, 42, nil)
	}
}
...
func TestCluster_Update(t *testing.T) {
	...
	if err != nil || v != 42 {
		t.Errorf("Update() == (%v, %q), want (%v, %q)", v, err, 42, nil)
	}
}
